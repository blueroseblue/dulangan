...
if (isset($_POST['id'])) {
    ...
    $sql_update = "UPDATE clearance_req SET req_status = '2' WHERE request_id = '$id'";
    ...
    if ($result_update) {
        ...
        $parameters = array(
            ...
            'message' => "Hello $fullname, your document request has been rejected." . $customMessage, // Personalized message
